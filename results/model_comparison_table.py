...
# Copy files to GitHub repository folder
github_repo_dir = os.path.join(os.path.dirname(script_dir), 'twitter_sentiment_analysis', 'results')
...
print(f"Files also copied to GitHub repo: {github_repo_dir}")